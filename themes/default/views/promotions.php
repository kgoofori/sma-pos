...
<head>
    ...
    <title>Pesonet Promotional Page</title>
    ...
    <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
            ...
            <div class="masthead clearfix">
                <div class="inner">
                    <h3 class="text-center">Pesonet Limited</h3>
                </div>
            </div>

            <div class="inner cover">
                <h1 class="cover-heading">Pesonet Stockman</h1>
                <p class="lead">Pesonet Stockman is php based web application for small and medium business to manage inventory, sales (with online payments), expenses, customers and warehouses. </p>
                <p class="lead">
                    <a href="http://pesonets.com" class="btn btn-lg btn-primary">Visit Our Website</a>
                </p>
            </div>

            <div class="mastfoot">
                <div class="inner">
                    <p>Pesonet Stockman by <a href="http://pesonets.com">Pesonet</a>.</p>
                </div>
            </div>
